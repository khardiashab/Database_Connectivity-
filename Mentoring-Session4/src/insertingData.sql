 -- inserting data to the database lpg
 
 use LPG;
 
 -- insert data to cust_details
 insert into  cust_details(name, gender, address, phone_no, connection_type, no_of_cylinders) values
	('Harish', 'M', '1-2, bnglr', 1234567890, 14.2, 1);
...
insert into pricing values(14.2, 'November', 2023, 970);
insert into pricing values(19.0, 'November', 2023, 1313);
insert into pricing values(5.0, 'November', 2023, 350);
